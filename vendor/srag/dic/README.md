...
```php
\srag\DIC\MultiAssign\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\MultiAssign\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\MultiAssign\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
