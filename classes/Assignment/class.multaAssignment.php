...
class multaAssignment extends ActiveRecord {
	 ...
	 * @return string
	 */
	public static function getListForToken($type, $token) {
		switch ($type) {
			case multaConfig::P_LIST_ADMIN:
				$role = self::ROLE_ADMIN;
				break;
			case multaConfig::P_LIST_TUTOR:
				$role = self::ROLE_TUTOR;
				break;
			case multaConfig::P_LIST_MEMBER:
...
//		$list = self::where(array('request_token'))
	}
